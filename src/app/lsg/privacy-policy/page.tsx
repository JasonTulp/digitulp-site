// Privacy policy for Little Space Game
export default function PrivacyPolicy() {
    return (
        <div className="max-w-[1200px] bg-mid p-16">
            <div className="pt-12"></div>
            <strong className="text-primary text-3xl">Little Space Game Privacy Policy</strong>
            <p>This privacy policy applies to the Little Space Game app (hereby referred to as "Application") for mobile devices that was created by Digitulp Ltd (hereby referred to as "Service Provider") as an Ad Supported service. This service is intended for use "AS IS".</p>
            <br />
            ...
            <br />
            <strong className="text-primary text-xl">Third Party Access</strong>
            ...
            <p></p>
            <br />
            <strong className="text-primary text-xl">Opt-Out Rights</strong>
            <p>You can stop all collection of information by the Application easily by uninstalling it. You may use the standard uninstall processes as may be available as part of your mobile device or via the mobile application marketplace or network.</p>
            <br />
            <strong className="text-primary text-xl">Data Retention Policy</strong>
            <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you&apos;d like them to delete User Provided Data that you have provided via the Application, please contact them at support@digitulp.co and they will respond in a reasonable time.</p>
            <br />
            <strong className="text-primary text-xl">Children</strong>
            ...
            <div>
                ...
                personal information, please contact the Service Provider (support@digitulp.co) so that
                they will be able to take the necessary actions.</p>
            </div>
            <br />
            <strong className="text-primary text-xl">Security</strong>
            ...
            <br />
            <strong className="text-primary text-xl">Contact Us</strong>
            <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at support@digitulp.co.</p>
        </div>
    );
}